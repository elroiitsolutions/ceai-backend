...
export interface ApiCityPageCityPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    businessDistricts: Schema.Attribute.Component<
      'shared.business-district',
      true
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    headerImage: Schema.Attribute.Media<'images', true>;
    keyAdvantages: Schema.Attribute.Component<'shared.feature-item', true>;
    latestPolicies: Schema.Attribute.Component<
      'shared.policy-regulation',
      true
    >;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'cityName'> & Schema.Attribute.Required;
...
export interface ApiCultureCulture extends Struct.SingleTypeSchema {
  collectionName: 'cultures';
  info: {
    description: 'Culture section page';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::culture.culture'
    >;
    policies: Schema.Attribute.Component<'shared.policy-regulation', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEventEvent extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Event section page';
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    column1Links: Schema.Attribute.Component<'layout.footer-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    column2Links: Schema.Attribute.Component<'layout.footer-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiIndustrialPageIndustrialPage
  extends Struct.SingleTypeSchema {
  collectionName: 'industrial_pages';
  info: {
    description: 'Content for the Industrial Zones page';
    displayName: 'Industrial Page';
    pluralName: 'industrial-pages';
    singularName: 'industrial-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::industrial-page.industrial-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    seoMeta: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiIndustrialIndustrial extends Struct.CollectionTypeSchema {
  collectionName: 'industrials';
  info: {
    displayName: 'Industrial';
    pluralName: 'industrials';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exclusiveIncentives: Schema.Attribute.Component<
      'shared.feature-item',
      true
    >;
    keyAdvantages: Schema.Attribute.Component<'shared.feature-item', true>;
...
export interface ApiInvestmentInvestment extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Investment section page';
...
export interface ApiLaborLabor extends Struct.SingleTypeSchema {
  collectionName: 'labors';
  info: {
    description: 'Labor section page';
    displayName: 'Labor Page';
    pluralName: 'labors';
    singularName: 'labor';
  };
  options: {
  ...
  attributes: {
    ...
    headerImage: Schema.Attribute.Media<'images', true>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::labor.labor'>;
    policies: Schema.Attribute.Component<'shared.policy-regulation', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiMissionMission extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Mission & Vision Page';
...
export interface ApiPolicyPolicy extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Policy section page';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    country: Schema.Attribute.Enumeration<['India', 'Taiwan']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }> &
      Schema.Attribute.DefaultTo<'Taiwan'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiZoneZone extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industrial Zones information';
  ...
  attributes: {
    ...
    country: Schema.Attribute.Enumeration<['Taiwan', 'India']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    keyIndustries: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::industrial-page.industrial-page': ApiIndustrialPageIndustrialPage;
      'api::industrial.industrial': ApiIndustrialIndustrial;
      'api::investment.investment': ApiInvestmentInvestment;
      'api::labor.labor': ApiLaborLabor;
